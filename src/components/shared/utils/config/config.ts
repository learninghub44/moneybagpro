...
export const DOMAIN_CONFIG: Record<string, DomainConfig> = {
    ...
    ...createHostedDomainEntries({
        ...
        ui: createDomainShellUI('Money Bag Pro', {
            primaryColor: '#d4af37',
    ...
    ...createHostedDomainEntries({
        primaryDomain: 'moneypool.site',
        aliases: ['www.moneypool.site'],
        clientId: '340V5HkFhPHZLZffC7lQj',
        appId: '',
        redirectUri: 'https://moneypool.site/callback',
        ...
        ui: createDomainShellUI('Money Pool', {
            primaryColor: '#14b8a6',
