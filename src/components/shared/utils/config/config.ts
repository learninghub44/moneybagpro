...
const createDomainShellUI = (
    ...
    // Every site's chrome is forced to a light/white shell for readability —
    // brand colors stay as accents only (buttons, active nav, borders), never
    // as full-panel backgrounds, so nothing renders as a dark/black surface.
    const SHELL_WHITE = '#ffffff';
    const SHELL_OFF_WHITE = '#f8fafc';
    const SHELL_MUTED = '#eef2f6';
    const SHELL_TEXT_DARK = '#0f172a';
    const SHELL_TEXT_MUTED = '#475569';
    ...
    return {
        ...
        secondaryColor,
        accentColor,
        headerBgColor: SHELL_WHITE,
        headerTextColor: SHELL_TEXT_DARK,
        sidebarBgColor: SHELL_OFF_WHITE,
        sidebarTextColor: SHELL_TEXT_DARK,
        buttonPrimaryBg: primaryColor,
        buttonPrimaryText: '#ffffff',
        buttonSecondaryBg: secondaryColor,
        buttonSecondaryText: '#ffffff',
        cardBgColor: SHELL_WHITE,
        cardBorderColor: sectionBorder,
        textPrimary: SHELL_TEXT_DARK,
        textSecondary: SHELL_TEXT_MUTED,
        successColor: runButton,
        warningColor: gold,
        customCssVars: {
            '--rm-shell-top': SHELL_WHITE,
            '--rm-shell-top-light': SHELL_WHITE,
            '--rm-shell-nav': SHELL_OFF_WHITE,
            '--rm-shell-nav-active': navActive,
            '--rm-shell-nav-hover': navHover,
            '--rm-shell-gold': gold,
            '--rm-shell-text': SHELL_TEXT_DARK,
            '--rm-shell-header-text': SHELL_TEXT_DARK,
            '--rm-shell-nav-text': SHELL_TEXT_DARK,
            '--rm-shell-panel-text': SHELL_TEXT_DARK,
            '--rm-shell-panel-text-muted': SHELL_TEXT_MUTED,
            '--rm-shell-surface': SHELL_WHITE,
            '--rm-shell-surface-2': SHELL_OFF_WHITE,
            '--rm-shell-border': sectionBorder,
            '--rm-shell-input-bg': SHELL_WHITE,
            '--rm-shell-input-text': SHELL_TEXT_DARK,
            '--rm-shell-button-text': '#ffffff',
            '--rm-shell-circle-bg': navActive,
            '--rm-shell-circle-text': '#ffffff',
            '--rm-shell-muted': SHELL_TEXT_MUTED,
            '--rm-shell-auth-blue': SHELL_WHITE,
            '--rm-shell-auth-border': authBorder,
            '--rm-shell-run': runButton,
            '--rm-shell-run-hover': runButtonHover,
            '--rm-shell-run-panel': SHELL_WHITE,
            '--rm-shell-run-panel-light': SHELL_WHITE,
            '--rm-shell-section': SHELL_WHITE,
            '--rm-shell-section-2': SHELL_OFF_WHITE,
            '--rm-shell-section-muted': SHELL_MUTED,
...
export const DOMAIN_CONFIG: Record<string, DomainConfig> = {
    ...
    ...createHostedDomainEntries({
        ...
        includeLegacyAppIdInOAuth: false,
        derivSignupUrl: 'https://partner-tracking.deriv.com/click?a=36324&o=1&c=3&link_id=1',
        features: {
            autoTrades: true,
            manualTrading: true,
        },
        ui: {
            ...createDomainShellUI('Money Bag Pro', {
                primaryColor: '#d4af37',
                secondaryColor: '#0f172a',
                accentColor: '#22c55e',
                headerBgColor: '#0b0b0d',
                sidebarBgColor: '#111113',
                navBg: '#1a1a1d',
                navActive: '#d4af37',
                navHover: '#c9a227',
                pageBg: '#0b0b0d',
                ...
                sectionBg2: '#1c1c1f',
                sectionMuted: '#232326',
                sectionBorder: 'rgba(212, 175, 55, 0.28)',
                panelBorder: '#d4af37',
                panelBorderSoft: 'rgba(212, 175, 55, 0.18)',
                runButton: '#15803d',
                runButtonHover: '#16a34a',
                authBlue: '#1a1a1d',
                authBorder: '#d4af37',
                gold: '#d4af37',
            }),
    ...
    ...createHostedDomainEntries({
        primaryDomain: 'www.moneypool.site',
        aliases: ['moneypool.site'],
        clientId: '341ScmHW9FBamx7Vr0hIf',
        appId: '',
        redirectUri: 'https://www.moneypool.site/callback',
        botsFolder: 'moneypool.site',
        includeLegacyAppIdInOAuth: false,
        derivSignupUrl:
            'https://deriv.partners/rx?sidc=18E28835-C6FC-4F58-8C23-95F98688752D&utm_campaign=dynamicworks&utm_medium=affiliate&utm_source=CU237371',
        features: {
            autoTrades: true,
            manualTrading: true,
        },
        ui: {
            ...createDomainShellUI('Money Pool', {
                primaryColor: '#14b8a6',
                secondaryColor: '#0e7490',
                accentColor: '#fbbf24',
                headerBgColor: '#042f2e',
                sidebarBgColor: '#134e4a',
                navBg: '#0f766e',
                navActive: '#0d9488',
                navHover: '#14b8a6',
                pageBg: '#083344',
                ...
                sectionBg2: '#0e7490',
                sectionMuted: '#0891b2',
                sectionBorder: 'rgba(20, 184, 166, 0.34)',
                panelBorder: '#14b8a6',
                panelBorderSoft: 'rgba(20, 184, 166, 0.22)',
                runButton: '#0d9488',
                runButtonHover: '#2dd4bf',
                authBlue: '#0e7490',
                authBorder: '#5eead4',
